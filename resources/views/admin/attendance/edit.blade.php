...
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="mb-0">Sửa chấm công</h5>
        <small class="text-muted float-end">Cập nhật thông tin chấm công</small>
    </div>
    <div class="card-body">
        <form method="POST" action="{{ route('attendance.update', $attendance->attendance_id) }}">
            @csrf
            @method('PUT')
