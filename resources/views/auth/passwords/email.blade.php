                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-6">
                            <a href="index.html" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-heading fw-bold">Hrm system</span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-1">Quên mật khẩu? 🔒</h4>
                        <p class="mb-6">Nhập email của bạn và chúng tôi sẽ gửi hướng dẫn để đặt lại mật khẩu</p>
